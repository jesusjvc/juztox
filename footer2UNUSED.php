    ...
    <?php if(!is_front_page() ) { ?>       
            ...
            //ajustes del Datepicker de la tienda, desactivado en la principal 
                ...
                $.datepicker.setDefaults(options);
                  $("body").on("focus", ".wccpf-datepicker-cundo_quieres_tus_jugos", function(){
                      $(this).datepicker( {                                                                
                        dateFormat:'dd-mm-yy',minDate: 1, beforeShowDay: function( date ){ var day = date.getDay();return [ ( day != 0 )];  }  
        ...
        */
        ...
        jQuery(document).ready(function($){     
            ...
            var unavailableDates = ["4-2-2019", "5-2-2019"];
          ...
          function check_puebla(date) {
            ...
            $(function() {
                lugar = $("#billing_state").val();
                //console.log( "ready! states mind my blowing" );
                
                            if (lugar == "DISTRITO FEDERAL") {
                     //ajustes del Datepicker de la tienda
                     console.log(lugar);                       
                     $('#e_deliverydate').datepicker('setDate', null);
